...
> 💡 In this section you can fill all the relevant information. Don't worry if you can't complete it when the project starts — that is the purpose of the **Discovery Phase**.
...
#### 📝 Project Brief
Describe the context of your project, fill in the deadlines and key milestones.

**Column 2**

#### ✅ The Objectives
Fill here the objectives of your project.
- Objective 1
- Objective 2
...
#### 📈 The Metrics
> 💡 **KPIs** and Design metrics are the key tools to make decisions and measure the success of your project.

**Column 2**

#### 🧑‍🚀 The Team
- Wojciech Pawlak — Lead Product Designer
- Justine Rolland — Service Designer

> Note: the names above come verbatim from the source template and should be replaced with the actual project team when used.
...
Made in Paris ❤️
By PRCSS*
Any feedback ? Send us a word here → prcss.design@gmail.com
```
