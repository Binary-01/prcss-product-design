...
_Replace every `{{PLACEHOLDER}}` with project specifics. This skeleton mirrors the PRCSS\* project page — keep the three sections and the callouts._

---

## 🕹 Project Info

> 💡 In this section you can fill all the relevant information. Don't worry if you can't complete it as the project starts — that is the purpose of the **Discovery Phase**.
...
- Key milestones: {{MILESTONE_1}}, {{MILESTONE_2}}
...
- {{KPI_1}} — baseline: {{BASELINE}} — target: {{TARGET}}
- {{KPI_2}} — baseline: {{BASELINE}} — target: {{TARGET}}
...
Version: 1.0 · Based on PRCSS\* — prcss.design@gmail.com
